...
class MediaEnlargedView extends StatelessWidget {
  ...
  MediaEnlargedView(this.chat, this.toUser, this.showPickerButton,this.autoplay);
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: (showPickerButton)
                      ? MediaPickerButton(
                          chat, toUser, ChatModel.VIDEO,false)
                      : Container(
                          width: 0,
                          height: 0,
                        ), 
...
class MediaEnlargedViewArgs {
  ...
  MediaEnlargedViewArgs(
      this.chat, this.enlargedView, this.toUser, this.showPickerButton,this.autoplay);
}
